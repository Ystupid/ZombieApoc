...
namespace UnityEngine.UI.FitterGroup
{
    ...
    {
        protected ILayoutable m_Layoutable;

        protected Queue<int> m_ClearQueue;
        protected Dictionary<int, RectTransform> m_ItemMap;
        ...
        protected virtual int ItemCount => m_Layoutable.ItemCount;
        protected Vector2 CellSize => m_Layoutable.CellSize;
        protected int ConstraintCount => m_Layoutable.ConstraintCount;
        protected Vector2 CellSpacing => m_Layoutable.CellSpacing;
        protected Padding Padding => m_Layoutable.Padding;
        protected ScrollRect ScrollRect => m_Layoutable.ScrollRect;
        protected RectTransform TargetRect => m_Layoutable.TargetRect;
        ...
        public LayoutBase() 
        {
            ...
            m_ItemMap = new Dictionary<int, RectTransform>();
        } 

        public virtual void Init(ILayoutable layoutable)
        {
        ...
        /// 重置可视范围
        /// </summary>
        protected abstract void ResetVisualScope();
        ...
        protected virtual RectTransform ResetAnchor(RectTransform itemRect)
        {
        ...
        /// <returns></returns>
        protected abstract RectTransform ResetPosition(RectTransform itemRect, int index);
        ...
        protected virtual void EnableItem(int index)
        {
            ...
            var itemRect = m_Layoutable.EnableItem(index);
            if (itemRect == null) return;
            m_ItemMap.Add(index, ResetPosition(ResetAnchor(itemRect), index));
        }
        ...
        {
            if (!HasItem(index)) return;
            m_Layoutable.DisableItem(index, m_ItemMap[index]);
